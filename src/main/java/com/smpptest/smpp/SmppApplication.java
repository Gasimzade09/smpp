...
public class SmppApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SubmitSm sm = createSubmitSm("Test", "994776160161", "Привет землянин!", "UCS-2");
            ...
            Logger.getLogger(SmppApplication.class.getName()).log(Level.SEVERE, null, ex);
